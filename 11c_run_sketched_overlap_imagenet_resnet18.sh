...
source $WORK/miniconda3/bin/activate hessov

# globals
OBS_DATASETS_PATH=~/datasets/DeepOBS
PROBLEM="imagenetdet_resnet18"  # NOTE WE ONLY COMPUTE TEST MATRICES
RANDOM_SEED=12345
OUTPUT_DIR="output"
MEASDIR_NAME="measurements"
MEAS_FLAG="measured"
NUM_HESSIAN_DATAPOINTS=5000
...
#
MEAS_PER_JOB=100
MEAS_JOB_DURATION="0-23:59"
#
TRAIN_PARTITION="a100-galvani"  # overrides script
MEAS_PARTITION="a100-galvani"
MEAS_RAM=128
OVERLAP_RAM=400
OVERLAP_PARTITION="a100-galvani"
NUM_A_POSTERIORI=0
WITH_A_POSTERIORI=0  # no a posteriori for the moment, takes too long
#
...
# rm -rf $meas_dir
echo "Done! NOT deleting" $meas_dir
